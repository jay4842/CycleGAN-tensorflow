...
parser.add_argument('--dataset_dir', dest='dataset_dir', default='ice', help='path of the dataset')
...
parser.add_argument('--load_size', dest='load_size', type=int, default=158, help='scale images to this size')
